                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group <?= form_error('level') ? 'has-error' : null ?>">
                                    ...
                                    <select name="level" id="" class="form-control">
                                        <option value="1" <?= $this->input->post('level') ?? $user->level == 1 ? "selected" : null ?>>Admin</option>
                                        <option value="2" <?= $this->input->post('level') ?? $user->level == 2 ? "selected" : null ?>>Cashier</option>
                                    </select>
